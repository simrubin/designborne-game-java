...
public class Location implements Printable {
	...
	/**
	 * Returns true if this location has a custom display string (emoji).
	 * 
	 * @return true if the location contains something with a custom display
	 */
	@Override
	public boolean hasCustomDisplay() {
		...
		return thing.hasCustomDisplay();
	}
	
	/**
	 * Returns the string to display for this location.
	 *
	 * If there is an Actor here, they are drawn. If there is no Actor, then any items present are drawn.
	 * If there is no Actor and no item, then the ground symbol is drawn.
	 *
	 * @return the string to draw for this location
	 */
	@Override
