...
import game.entity.enemy.RedWolf;
...
/**
 * The RedWolfSpawner class is responsible for spawning a RedWolf at a given location based on weather conditions.
...
public class RedWolfSpawner implements Spawner {
     ...
     */
    private final float RAINY_SPAWN_PROBABILITY = 0.45f;
    ...
    /**
     * Spawns a RedWolf at the given location if certain conditions are met, considering the current weather.
     *
