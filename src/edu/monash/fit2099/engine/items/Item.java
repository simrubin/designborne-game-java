...
public abstract class Item extends GameEntity implements Printable {
	...
	/**
	 * Returns the Item's display string, so that it can be displayed in the UI.
	...
	/**
	 * Set a custom display string (like an emoji) for this Item.
	...
	/**
	 * Check if this Item has a custom display.
	 * @return true if the Item has a custom display string
	 */
	@Override
