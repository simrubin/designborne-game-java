...
public abstract class Actor extends GameEntity implements Printable {
    ...
    /**
     * A custom string display (like an emoji) that can be used instead of the displayChar
     */
    private String displayString;
    /**
     * Whether this actor has a custom display string
     */
    ...
    /**
     * Returns the Actor's display string, so that it can be displayed in the UI.
     * @return the Actor's display string
     */
    ...
    /**
     * Replace current display string.
     * @param displayString the new display string for the Actor
     */
    ...
    /**
     * Check if this Actor has a custom display.
     * @return true if the Actor has a custom display string
     */
